...
//   {/* Title stays outside the bordered form */}
//   <Text style={styles.title}>TRACK STATUS</Text>

//   {/* Form container: input + button + search results */}
...
//     width: '90%',
//   maxWidth: 400,
//   maxHeight: 400,            // ✅ limit height to prevent it from pushing title/logo
//   borderWidth: 2,
//   borderColor: '#90EE90',
//   borderRadius: 10,
//   padding: 20,
...
//     height: 50,
//     borderWidth: 2,
//     borderColor: '#32CD32', // Green border for input
//     borderRadius: 8,
...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    height: 50,
    borderWidth: 2,
    borderColor: '#32CD32',   // green always
    borderRadius: 8,
    paddingHorizontal: 15,
    fontSize: 16,
    marginBottom: 10,
